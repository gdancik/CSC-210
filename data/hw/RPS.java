...
public class RPS {
	...
	public static void main(String[] args) {
		...
		String playAgain; // player's response when asked to play again
		boolean again = true;	// true if the player wants to play again; false otherwise
		
		// (1) FIX ME: prompt the user to enter his/her name, 
		// and store the name in the String 'name' which is declared above
		...
		while (again) {
			...
			// and store the letter in the character variable 'player' which is declared above
			...
			// the variable 'computer' which is declared above
			...
			// which are stored in the variables 'player' and 'computer', using 
			// this format:  Player ---> R      P <--- CPU
			...
			// (8) FIX ME: prompt the user to Play again (Yes/No)?
